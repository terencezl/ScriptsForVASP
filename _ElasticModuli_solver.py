...
if cryst_sys == 'cubic':
    ...
    theta_D = h/k_B * (3*total_atoms/4/np.pi * (N_A*row)/molar_mass)**(1/3.) * v_m
    print("B = %f, G_V = %f , G_R = %f , G = %f , E = %f , nu = %f , k = %f , cauchy_pressure = %f, H_V = %f , theta_D = %f" % (B, G_V, G_R, G, E, nu, k, cauchy_pressure, H_V, theta_D))
